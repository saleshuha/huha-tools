-- Update the get_all_po_orders function to remove any limits and return all records
-- The current function might have a default limit that's causing only 1000 records to be returned
...
BEGIN
  ...
  -- Removed any LIMIT clause to return ALL records
END;
$function$