          ...
          <SidebarProvider>
            <div className="min-h-screen flex w-full">
              ...
              <div className="flex-1 flex flex-col">
                <header className="h-16 flex items-center border-b border-border/40 bg-card/80 backdrop-blur-xl shadow-medium">
                  <div className="flex items-center justify-between w-full gap-6 pl-6 pr-6">
                    <div className="flex items-center gap-4">
                      <SidebarTrigger className="bg-gradient-to-r from-primary to-primary-light hover:from-primary-dark hover:to-primary text-primary-foreground border-primary shadow-soft hover:shadow-glow transition-all duration-300 hover:-translate-y-0.5" />
                      <div className="bg-gradient-to-br from-primary/20 to-emerald/20 rounded-xl p-2 backdrop-blur-sm shadow-soft">
                        <img 
                      ...
                      <div className="flex flex-col">
                        <h1 className="font-bold text-lg text-foreground tracking-wide bg-gradient-to-r from-primary to-emerald bg-clip-text text-transparent">HuHa Product Management System</h1>
                        <p className="text-xs text-muted-foreground font-medium leading-tight">Professional Inventory & Analytics Platform</p>
                      </div>
                    </div>
                    <div className="flex-1 flex justify-center">
                      <div className="glass-container px-6 py-2 backdrop-blur-sm">
                        <span className="text-sm font-medium text-foreground bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">اللَّهُمَّ صل عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ</span>
                      </div>
                    </div>
                    <CountrySwitcher />
                  </div>
