-- Fix the get_items_needing_restock function to exclude items with status 'ordered'
-- This will solve the issue where marked items keep appearing after refresh
