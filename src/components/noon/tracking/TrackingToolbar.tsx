...
interface TrackingToolbarProps {
  ...
  stores: Array<{ id: string; name: string; country: string }>;
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <Input
                placeholder="Search orders, SKUs, items..."
                value={searchTerm}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 bg-card border border-border/50 rounded-lg p-1">
              ...
              <Button
                ...
                className={cn(
                  "h-8 px-3",
                  viewMode === 'pipeline' && "bg-primary text-primary-foreground shadow-sm"
                )}
              >
            ...
            <Button
              ...
              className={cn(
                "relative",
                exceptionCount > 0 && "border-warning text-warning hover:bg-warning/10"
              )}
            >
