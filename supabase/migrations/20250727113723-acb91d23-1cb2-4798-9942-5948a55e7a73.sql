-- Revert the function to show ordered items but keep quantity-based filtering
-- This allows UI to show order status while removing items when stock is added
