          ...
          <SidebarProvider>
            <div className="min-h-screen flex w-full">
              ...
              <div className="flex-1 flex flex-col">
                <header className="h-16 flex items-center border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
                  <div className="flex items-center justify-between w-full gap-4 px-6">
                    <div className="flex items-center gap-4">
                      <SidebarTrigger className="h-8 w-8 bg-transparent hover:bg-accent text-foreground border-input shadow-sm" />
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <h1 className="font-semibold text-lg text-foreground tracking-tight">Seller Central</h1>
                          <p className="text-xs text-muted-foreground font-medium leading-tight">Product Management System</p>
                        </div>
                      </div>
                    </div>
                    <div className="flex-1 flex justify-center max-w-md">
                      <div className="text-center">
                        <span className="text-sm font-medium text-foreground block">اللَّهُمَّ صل عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ</span>
                        <span className="text-xs text-muted-foreground">Professional Analytics Platform</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <CountrySwitcher />
