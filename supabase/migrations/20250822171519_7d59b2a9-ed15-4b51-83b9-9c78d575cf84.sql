...
BEGIN
  ...
  SELECT 
    ...
    COUNT(CASE WHEN po.status = 'pending' THEN 1 END)::bigint as pending_line_items,
    SUM(CASE WHEN po.status = 'pending' THEN po.quantity ELSE 0 END)::bigint as pending_quantity,
