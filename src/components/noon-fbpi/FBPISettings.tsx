...
import { Loader2, CheckCircle2, XCircle, Settings, Key } from 'lucide-react';
import type { NoonStoreConfig } from '@/hooks/useNoonFBPI';
...
export function FBPISettings({ stores, loading, onTestConnection, onUpdateCredentials }: FBPISettingsProps) {
