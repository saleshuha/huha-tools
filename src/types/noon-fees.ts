// Import the comprehensive header mapping
import { NOON_FEES_HEADERS } from './noon-fees-headers';

export interface NoonOrderFeesData {
  id_partner?: string;
  marketplace?: string;
  order_nr: string; // Required field
  item_nr?: string;
...
// Use the comprehensive headers from the dedicated file (convert readonly to mutable)
export const NOON_FEES_EXPECTED_HEADERS: string[] = [...NOON_FEES_HEADERS];