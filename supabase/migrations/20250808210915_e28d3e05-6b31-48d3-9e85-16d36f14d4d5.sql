-- Drop and recreate the get_all_po_orders function to remove any limits
-- This should fix the issue where only 1000 records are being returned
...
BEGIN
  ...
  -- No LIMIT clause - returns ALL records
END;
$function$