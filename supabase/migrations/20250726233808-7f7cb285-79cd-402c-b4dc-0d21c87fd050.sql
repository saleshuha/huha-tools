-- Update the get_items_needing_restock function to accept a country parameter
-- This will ensure that only items from the selected country are returned

CREATE OR REPLACE FUNCTION public.get_items_needing_restock(country_filter text DEFAULT NULL)
