-- Create an optimized version of the order fees analysis function
...
BEGIN
  ...
  WITH limited_invoice_data AS (
    SELECT 
      ...
      i.user_id,
      'Store' as store_name -- Simplified for now
  ...
  fees_lookup AS (
    ...
    WHERE f.country_code = country_filter
      ...
      AND EXISTS (
        ...
        WHERE o.order_number = f.order_nr 
           OR o.item_nr = f.item_nr 
           OR o.order_number = f.item_nr
      )
