-- Create a more robust function that returns ALL PO orders with proper handling
CREATE OR REPLACE FUNCTION public.get_all_po_orders_with_sku_data(user_id_param uuid)
RETURNS TABLE(
  id uuid,
  user_id uuid,
  po_number text,
